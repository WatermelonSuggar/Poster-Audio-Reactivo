...
function buildOpticalInterlace() {
  ...
  for (let y = 0; y < H; y++) {
    for (let x = 0; x < W; x++) {
      ...
      // fuente A: cámara monocromática normal
      ...
      // fuente B: cámara desplazada y espejada
      ...
      // pequeñas líneas internas para reforzar la ilusión óptica
...
function drawPanelBase() {
  ...
  textSize(24);
  fill(150);
  text(SUBTITLE_TEXT, panel.x + panel.w / 2, panel.y + 130);
}
