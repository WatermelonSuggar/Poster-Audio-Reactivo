...
let moderateStyleIndex = 0;

// estilos disponibles solo para el estado moderado
const moderateStyleSequence = [1, 2, 3, 4];
...
function updateMovementState() {
  ...
  // Cada vez que cambia el estado de movimiento:
  // 1. cambia al siguiente filtro
  // 2. cambia la organización del mosaico según el nuevo estado
...
function drawInterfaceText() {
  ...
  text(`Estilo actual: ${styles[currentStyleIndex].name}`, panel.x + 34, panel.y + 663);
